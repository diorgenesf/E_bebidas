...
--
-- Host: 127.0.0.1
-- Generation Time: 24-Jun-2014 às 19:45
...
CREATE TABLE IF NOT EXISTS `pedido` (
  ...
  `status` varchar(1) NOT NULL DEFAULT 'a' COMMENT 'a=Ativo\nc=Cancelado',
  `data` date NOT NULL,
  `valorTotal` decimal(9,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`idpedido`),
  KEY `fk_pedido_usuario1_idx` (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `type` varchar(1) NOT NULL DEFAULT 's' COMMENT 's = simple\na = administrator',
...
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `fk_pedido_usuario1` FOREIGN KEY (`username`) REFERENCES `usuario` (`username`) ON DELETE NO ACTION ON UPDATE NO ACTION;
