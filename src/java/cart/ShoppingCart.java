...
public class ShoppingCart {
     ...
     * incremented.
     *
     * @param product the <code>Produto</code> that defines the type of shopping cart item
    ...
    public synchronized void addItem(Produto product) {
        ...
        for (ShoppingCartItem scItem : items) {
            ...
            if (scItem.getProduto().getIdproduto() == product.getIdproduto()) {
    ...
    public synchronized double getSubtotal() {
        ...
        for (ShoppingCartItem scItem : items) {
            ...
            amount += (scItem.getQuantity() * Price.doubleValue());
        }
